...
<body>
  ...
  <div class="login">
      ...
      <strong><a class="logo"> &nbsp; &nbsp; &nbsp;<b><img style="width: 50px; " src="<?php echo base_url() ?>assets/uploads/logo.png" alt="home" /><span >LISTRIKU | Pelanggan</span></a></h1>
      <form method="post" action="<?php echo base_url() ?>login/dologin_p">
