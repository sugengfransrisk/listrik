...
<html>
    <head>
       ...
       <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
        ...
        <!-- Theme style -->
        <link rel="stylesheet" href="<?php echo base_url('resources/css/pelangganLTE.min.css');?>">
        <!-- pelangganLTE Skins. Choose a skin from the css/skins
    ...
    <body class="hold-transition skin-white sidebar-mini">
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="" style="height: 45px; widht: 60px" class="img-circle" alt="User Image">
                        </div>
                    ...
                    <li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>Pembayaran Listrik</span>
                            </a>
      ...
      <!-- jQuery 2.2.3 -->
        ...
        <!-- pelangganLTE for demo purposes -->
